...
namespace christopherdowson\sha1twigfilter;

use christopherdowson\sha1twigfilter\twigextensions\sha1TwigFilterTwigExtension;
 ...
 *
 */
class sha1TwigFilter extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Craft::$app->view->registerTwigExtension(new sha1TwigFilterTwigExtension());
